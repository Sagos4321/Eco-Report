        ...
        <div class="relative z-10 flex flex-col items-center justify-center h-full w-full px-4 md:px-6 py-10 md:py-20 text-center">
            <div class="max-w-4xl flex flex-col items-center gap-4 md:gap-8">
                ...
                <p class="max-w-2xl text-sm sm:text-base md:text-xl leading-relaxed text-white/90 drop-shadow-md">
                    Eco-Report merupakan platform digital yang berfungsi sebagai sarana partisipasi publik dalam menanggapi dampak pemanasan global, mendorong keadilan iklim, serta memperkuat penegakan ekosistem.
                </p>
                <div class="flex flex-col sm:flex-row items-center gap-3 md:gap-4 mt-2 md:mt-4 w-full justify-center">
                    
                    <a href="{{ url('/lapor') }}" class="group flex h-12 md:h-14 w-full sm:w-auto min-w-[160px] md:min-w-[180px] items-center justify-center gap-2 rounded-full bg-primary px-6 md:px-8 text-sm md:text-base font-bold text-white shadow-lg shadow-primary/40 transition-all hover:bg-[#9aac7d] hover:-translate-y-1">
                        <span>Bergabung & Lapor</span>
                        <span class="material-symbols-outlined transition-transform group-hover:translate-x-1">arrow_forward</span>
                    </a>
                    
                    <a href="{{ url('/jelajah') }}" class="flex h-12 md:h-14 w-full sm:w-auto min-w-[160px] md:min-w-[180px] items-center justify-center gap-2 rounded-full bg-white/10 px-6 md:px-8 text-sm md:text-base font-bold text-white border border-white/30 backdrop-blur-md shadow-soft transition-all hover:bg-white/20 hover:-translate-y-1">
                        <span class="material-symbols-outlined">play_circle</span>
                        <span>Lihat Dampak</span>
                    </a>
                </div>
            </div>
        </div>
        <div class="absolute bottom-0 left-0 right-0 h-24 bg-gradient-to-t from-earth-light to-transparent opacity-90"></div>
    </section>

</div>

<div id="dynamic-view" class="hidden w-full max-w-[1280px] mx-auto min-h-screen"></div>
@endsection